...
{    
    ...
    public interface IStockDeletion
    {
        ...
        [OperationContract]
        List<CStockDeletionReportSummary> FindStockDeletionSummary(DateTime startDate, DateTime endDate, string billType, string billNo, string productCode, string product, string narration, string financialCode);
        [OperationContract]
        List<CStockDeletionReportDetailed> FindStockDeletionDetailed(DateTime startDate, DateTime endDate, string billType, string billNo, string productCode, string product, string narration, string financialCode);
    }
